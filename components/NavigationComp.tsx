    ...
    <NavigationContainer>
      ...
      {user != undefined ? (
        <Tab.Navigator screenOptions={{ headerShown: false }} >
          <Tab.Screen name="Home" component={LoggedInLandingPage} options={{
            tabBarIcon: ({ }) => (
              <Icon name="home" size={30} color="#0000FF" />
            )
          }} />
          <Tab.Screen name="Events" component={EventStackNavigator} options={{
            tabBarIcon: ({ }) => (
              <Icon name="calendar" size={30} color="#0000FF" />
            )
          }} />
          <Tab.Screen name="Chat" component={ChatroomStackNavigator} options={{
            tabBarIcon: ({ }) => (
        ...
        <Tab.Navigator screenOptions={{ headerShown: false }}>
          <Tab.Screen name="Login" component={LandingPageStackNavigator} options={{
            tabBarIcon: ({ }) => (
              <Icon name="login" size={30} color="#0000FF" />
            )
          }} />
          <Tab.Screen name="Sign Up" component={SignUpPage} options={{
            tabBarIcon: ({ }) => (
